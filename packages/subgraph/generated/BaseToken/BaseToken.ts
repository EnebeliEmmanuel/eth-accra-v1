...
export class BaseToken__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class BaseToken__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class BaseToken extends ethereum.SmartContract {
  ...
  checkpoints(
    account: Address,
    pos: BigInt,
  ): BaseToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<BaseToken__checkpointsResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt,
  ): ethereum.CallResult<BaseToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<BaseToken__checkpointsResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  eip712Domain(): BaseToken__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new BaseToken__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<BaseToken__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BaseToken__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
